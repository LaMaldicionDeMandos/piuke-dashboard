...
@Component({
  selector: 'app-manufactures-stock',
  templateUrl: './manufactures_stock.component.html',
  styleUrls: ['./manufactures_stock.component.scss']
})
export class ManufacturesStockComponent implements OnInit {
